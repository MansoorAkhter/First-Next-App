...
const AboutUs = (props) => {
  return (
      <View style={{ flex: 1, backgroundColor: '#fff' }}>
          ...
          <View style={{ top:-10, height: 500, width: '100%'}}>
              <Text style={{fontSize:16,color:'grey',padding:20,left:-5}}>Farm Fresh Shop is the first Ecommerce Store who introduce
                  ...
                  orchards Our aim is to share the joy of  pakistan Mangoes with our co
              </Text>

              <Text style={{ fontSize: 16, color: 'grey', padding: 20, left: -5,top:-30 }}>
